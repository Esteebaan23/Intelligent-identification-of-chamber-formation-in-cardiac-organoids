...
│   ├── best_model_CH3.pth
│   ├── best_model_forming_CH1.keras
│   ├── best_model_nonforming_CH1.keras
│   ├── best_model_forming_CH2.keras
│   └── best_model_nonforming_CH2.keras
...
| `best_model_forming_CH1.keras`          | Staining       |
| `best_model_nonforming_CH1.keras`       | Staining       |
| `best_model_forming_CH2.keras`          | Staining       |
| `best_model_nonforming_CH2.keras`       | Staining       |
...
| File                               | Description                                       |
|------------------------------------|---------------------------------------------------|
| `{basename with CH3→CH1}.png`      | Synthesized CH1 channel at original input size    |
| `{basename with CH3→CH2}.png`      | Synthesized CH2 channel at original input size    |

Global summary: `results/staining_results.xlsx`
